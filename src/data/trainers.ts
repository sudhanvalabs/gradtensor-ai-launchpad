...
export const trainers: Trainer[] = [
  {
    ...
    bio: [
      ...
      "He has held senior leadership roles across 18 years at Hewlett-Packard including heading HP Software services delivery for the India region, served as Global Applications Director at a European manufacturing major, and was CTO for a European blockchain startup. Prabhu holds a Master's degree in Engineering from BITS, Pilani. A passionate educator at heart, he has authored two technical books - a commitment that reflects his drive to make complex engineering topics accessible to a wider audience.",
